...
function bot_ui_ini() {
    ...
    var sure = function () {
            ...
            botui.message.add({
                ...
                botui.message.add({
                    ...
                    botui.message.add({
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "折腾 HTML/CSS/JavaScript/PHP，偶尔去整黑苹果"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
                                content: "虽然已经整完了，后面我会面向AI进发"
                            }).then(function () {
                                botui.message.add({
                                    delay: 1800,
        ...
        thirdpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "樱花庄来自一部番剧(樱花庄的宠物女孩)，因为和主角有一样的爱好~ 如果有兴趣可以找找首页上的视频~"
            }).then(function () {
                botui.action.button({
                    delay: 1500,
                    action: [{
        ...
        fifthpart = function () {
            botui.message.add({
                delay: 1E3,
                content: "emmmm，看域名你就知道了=.= 这是Gitee Page"
            }).then(function () {
                botui.message.add({
                    delay: 1600,
